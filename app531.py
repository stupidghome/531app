...
# --- 1. THE "SKIN" ONLY (No logic changes) ---
st.set_page_config(page_title="5/3/1 Training", layout="centered")

st.markdown("""
    <style>
    /* 1. Make the base font 20% larger for gym use */
    html, body, [class*="st-"] {
        font-size: 1.2rem !important;
    }

    /* 2. Make the Checkbox MUCH larger */
    [data-testid="stCheckbox"] {
        transform: scale(1.8); /* Scales the actual box up */
        margin-left: 15px;
        margin-top: 10px;
        margin-bottom: 20px;
    }
    
    /* 3. Make buttons tall for thick fingers */
    .stButton > button {
    ...
    /* 4. Keep your Green "Complete" button */
